...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        ...
        cy.get('#lastName')
          .type('Osaida')
          .should('have.value', 'Osaida')
          .clear()
          .should('have.value', '')
        cy.get('#email')
          .type('willian.alberto.osaida@nttdata.com')
          .should('have.value', 'willian.alberto.osaida@nttdata.com')
          .clear()
          .should('have.value', '')
        cy.get('#phone')
          .type('48984901765')
          .should('have.value', '48984901765')
          .clear()
          .should('have.value', '')
    })
